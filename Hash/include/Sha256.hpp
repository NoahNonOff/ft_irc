...
namespace HASH {
	...
	class SHA256 {
		...
		/* ["https://www.youtube.com/watch?v=orIgy2MjqrA&ab_channel=RedBlockBlue"] {7 min} */
		...
		private:
			...
			// 64 binary words Ki given by the 32 first bit of the fractional parts
			// of the cube roots of the first 64 prime numbers:
			static const std::array<uint32_t, 64>	_K = {
